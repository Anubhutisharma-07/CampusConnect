...
- **Components & Services**:
  - `src/components/festivals/InteractiveFestivalRoadmap.tsx`
  - `src/services/festivalRoadmapService.ts`
  - `src/routes/events.$id.festival-roadmap.tsx`
  - `src/types/festivalRoadmap.ts`
  - `supabase/migrations/20261231000026_festival_multi_track_roadmap.sql`
- **Summary**:
